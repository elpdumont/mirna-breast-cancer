...
We concatenate the mir_id and mir_seq to have a unique identifier per miRNA and we name each row with the miRNA new name.
...
Now, we remove from the matrix of counts all samples that are not in the sample_info file.
...
## DESeq2 Analysis
miR_dds <- DESeqDataSetFromMatrix(counts_filt_df, colData = sample_info, design = ~ condition)
