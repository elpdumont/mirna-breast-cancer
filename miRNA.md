...
yield any good predictive results. The best we obtained was to select
miRNAs using the package DESeq, a bioinformatics package specializing in
differentialy-expressed miRNAs between two populations of samples, and
support vector machine model. This yieled a 71% accuracy and 71% AUC.
...
```
    ...
    ##                                  ol_srna_tmm1_k124g
    ## bhv1-mir-B1_CGGgGTTGGCGGCCGtCGG                   0
    ## bhv1-mir-B1_GCGTTGGCGGgCGaCGGGAA                  0
    ## bhv1-mir-B1_GTCCTCGGCGTgGcCGGC                    0
...
```
    ...
    ## There are  158 samples in the training dataset and 52 samples in the testing dataset
...
The best combination was to use miRNAs identified with DESeq2 and use
these miRNAs in a support vector machine model (linear kernel), yielding
to 71% accuracy.
